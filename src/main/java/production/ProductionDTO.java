	 ...
	 private int prod_key;
		...
		public String toString() {
			return "ProductionDTO [prod_key=" + prod_key + ", prod_code=" + prod_code + ", prod_date=" + prod_date
					+ ", input_qty=" + input_qty + ", good_qty=" + good_qty + ", defect_qty=" + defect_qty
					+ ", work_order_key=" + work_order_key + ", work_order_code=" + work_order_code + ", order_qty="
					+ order_qty + ", plan_key=" + plan_key + ", plan_code=" + plan_code + ", plan_qty=" + plan_qty
					+ ", item_key=" + item_key + ", item_code=" + item_code + ", item_name=" + item_name
					+ ", work_user_key=" + work_user_key + ", work_user_name=" + work_user_name + ", achievement_rate="
					+ achievement_rate + "]";
		}
