...
public class ProductionOptionDTO {
	...
	public String toString() {
		return "ProductionOptionDTO [work_order_key=" + work_order_key + ", work_order_code=" + work_order_code
				+ ", plan_key=" + plan_key + ", plan_code=" + plan_code + ", plan_qty=" + plan_qty + ", item_key="
				+ item_key + ", item_name=" + item_name + ", work_user_key=" + work_user_key + ", work_user_name="
				+ work_user_name + ", quality_key=" + quality_key + ", good_qty=" + good_qty + ", defect_qty="
				+ defect_qty + ", inspect_qty=" + inspect_qty + ", qc_status=" + qc_status + ", defect_reason="
				+ defect_reason + "]";
	}
