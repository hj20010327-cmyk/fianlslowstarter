...
public class ProductionSummaryDTO {
	...
	public String toString() {
		return "ProductionSummaryDTO [total_plan_qty=" + total_plan_qty + ", total_order_qty=" + total_order_qty
				+ ", total_good_qty=" + total_good_qty + ", total_defect_qty=" + total_defect_qty
				+ ", avg_achievement_rate=" + avg_achievement_rate + ", best_item_name=" + best_item_name
				+ ", best_rate=" + best_rate + ", low_item_name=" + low_item_name + ", low_rate=" + low_rate + "]";
	}
