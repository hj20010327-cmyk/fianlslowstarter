...
@WebServlet("/workorder/complete")
public class WorkOrderCompleteController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("/workorder/complete doPost 실행");
		...
		try {
			...
			if (workOrderKeys != null) {
				...
				for (String key : workOrderKeys) {
					service.completeWorkOrder(Integer.parseInt(key));
				}
			}
