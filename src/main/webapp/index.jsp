						...
						<main class="content">
							<div class="page-head">
								...
								<div class="page-actions">
									<a href="${pageContext.request.contextPath}/index" class="btn primary">현황 새로고침</a>
								</div>
							</div>
							...
							<section class="card" style="margin-top: 20px;">
								...
								<div class="master-grid">
									<a class="master-card" href="${pageContext.request.contextPath}/workorder.jsp">
										<strong>작업지시</strong>
									...
									</a> <a class="master-card" href="${pageContext.request.contextPath}/quality.jsp">
										<strong>품질관리</strong>
										<p>불량 수량, 검사 결과, 조치 내역을 관리합니다.</p> <span>바로 이동</span>
									</a> <a class="master-card" href="${pageContext.request.contextPath}/stock.jsp">
										<strong>재고관리</strong>
