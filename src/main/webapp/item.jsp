            ...
            <div class="page-head">
                ...
                <div class="page-actions">
                    <c:if test="${dto.user_role eq '관리자' or dto.user_role eq '슈퍼바이저'}">
                        <button class="btn primary" type="button" onclick="openInsertModal()">신규 자재 등록</button>
                    </c:if>
                </div>
            </div>
            ...
            <section class="card">
                ...
                <form action="${pageContext.request.contextPath}/item" method="get">
                    ...
                    <div class="search-row">
                        ...
                        <a href="${pageContext.request.contextPath}/item" class="btn">초기화</a>
                    </div>
                </form>
            </section>
                        ...
                        <div class="table-wrap">
                            ...
                            <div class="pagination">
                                <c:forEach var="i" begin="1" end="${totalPage > 0 ? totalPage : 1}">
                                    <a href="${pageContext.request.contextPath}/item?p=${i}&keyword=${keyword}"
