...
<body>
	<header class="header">
		<div class="header-left">
			<a href="./index.html" class="logo"> <span class="logo-mark">AM</span>
				<span>AUTO MES</span>
			</a>
	...
	<div class="layout">
		<aside class="snb" id="snb">
			...
			<div class="snb-section">
				...
				<ul class="snb-menu">
					<li class="active"><a href="./master.jsp">기준관리</a></li>
		...
		<main class="content">
			...
			<section class="hero-banner">
				...
				<div class="pill-row">
					<span class="pill">BOM 24건</span> <span class="pill">공정 12건</span>
			...
			<section class="grid-2">
				<div class="card">
					...
					<div class="master-grid">
						<a href="./bom.html" class="master-card"> <strong>BOM
								관리</strong>
							<p>제품별 구성 자재와 소요량을 관리합니다.</p> <span>총 24건</span>
						</a> <a href="./process.html" class="master-card"> <strong>공정
								관리</strong>
							<p>가공, 조립, 검사, 포장 공정을 관리합니다.</p> <span>총 12건</span>
						</a> <a href="./item.html" class="master-card"> <strong>품목
								관리</strong>
							<p>원자재, 부품, 반제품 품목 기준정보를 관리합니다.</p> <span>총 38건</span>
						</a> <a href="./product.html" class="master-card"> <strong>완제품
								관리</strong>
							<p>완제품 모델 및 출하 대상 품목을 관리합니다.</p> <span>총 16건</span>
						</a>
					</div>
				</div>
