			...
			<form method="post" action="mypage">
				<section class="two-col">
					<div class="card">
						...
						<div class="form-grid">
							<div class="form-group">
								<label>아이디</label> <input class="input" type="text"
									value="${dto.user_id}" readonly />
							</div>

							<div class="form-group">
								<label>사번</label> <input class="input" type="text"
									value="${dto.emp_no}" readonly />
							</div>

							<div class="form-group">
								<label>이름</label> <input name="name" class="input" type="text"
									value="${dto.user_name}" required />
							</div>

							<div class="form-group">
								<label>이메일</label> <input name="email" class="input"
									type="email" value="${dto.user_email}" />
							</div>

							<div class="form-group">
								<label>연락처</label> <input name="phone" class="input" type="text"
									value="${dto.user_phone}" />
							</div>

							<div class="form-group">
								<label>직책</label> <input class="input" type="text"
									value="${dto.user_role}" readonly />
							</div>
						</div>
					</div>
					...
					<div class="card">
						...
						<div class="form-grid">
							<div class="form-group">
								<label>현재 비밀번호</label> <input name="pw" class="input"
									type="password" />
							</div>
							<div class="form-group">
								<label>새 비밀번호</label> <input name="npw" class="input"
									type="password" />
							</div>
							<div class="form-group">
								<label>새 비밀번호 확인</label> <input name="cnpw" class="input"
									type="password" />
							</div>
						</div>
					</div>
				...
				<div class="page-actions" style="margin-top: 20px;">
					<input style="cursor: pointer;" class="btn primary" type="submit"
						value="저장">
				</div>
			</form>
		</main>
