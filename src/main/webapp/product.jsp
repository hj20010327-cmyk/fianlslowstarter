...
<head>
    ...
    <style>
        ...
        .status-Y { background: #f0fff4; color: #38a169; }
        .status-N { background: #fff5f5; color: #e53e3e; }
        ...
        .modal-footer { padding: 20px; display: flex; justify-content: center; gap: 12px; }
    ...
    <div class="layout">
        <aside class="snb">
            <div class="snb-section active">
                ...
                <ul class="snb-menu">
                    <li class="active"><a href="${pageContext.request.contextPath}/productList">완제품 관리</a></li>
        ...
        <main class="content">
            ...
            <div class="card">
                <div class="search-container">
                    <input type="text" id="searchKeyword" class="input-field" placeholder="품목명 또는 코드 입력" style="flex:3">
                    ...
                    <table>
                        ...
                        <tbody>
                            <c:forEach var="p" items="${list}">
                                <tr onclick="openModal('edit', '${p.itemKey}', '${p.itemCode}', '${p.itemName}', '${p.spec}', '${p.unit}', '${p.price}', '${p.safeQty}', '${p.status}')">
        ...
        <div class="modal-box">
            ...
            <form id="modalForm" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group"><label>품목코드</label><input type="text" name="itemCode" id="modal_code" class="input-field"></div>
                    <div class="form-group"><label>품목명</label><input type="text" name="itemName" id="modal_name" class="input-field"></div>
                    <div class="form-group"><label>규격</label><input type="text" name="spec" id="modal_spec" class="input-field"></div>
                    <div class="form-group"><label>단위</label><input type="text" name="unit" id="modal_unit" class="input-field"></div>
                    <div class="form-group"><label>단가</label><input type="number" name="price" id="modal_price" class="input-field"></div>
                    <div class="form-group"><label>안전재고</label><input type="number" name="safeQty" id="modal_safe" class="input-field"></div>
                    <div class="form-group"><label>상태</label>
                        <select name="status" id="modal_status" class="input-field">
