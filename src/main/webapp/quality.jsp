				...
				<div class="search-container">
					<div style="flex: 2">
						<input type="text" id="searchKeyword" class="input-field"
							placeholder="검사번호 입력" value="${param.keyword}">
					</div>
					<div style="flex: 1">
			...
			<div class="main-grid">
				<div class="card">
					<div class="section-header"
						...
						<h2>품질 목록</h2>
						<button type="button" class="btn-delete-custom"
						...
						<table>
							...
							<tbody>
								<c:forEach var="m" items="${list}">
									<fmt:formatDate var="fmtDate" value="${m.inspect_date}"
										pattern="yyyy-MM-dd" />
									<tr
										onclick="openEditModal('${m.quality_code}', '${m.inspect_qty}', '${m.qc_status}', '${fmtDate}')">
										<td onclick="stopProp(event)"><input type="checkbox"
											name="chk_quality" value="${m.quality_code}"></td>
		...
		<div class="modal-box">
			<div class="modal-header">
				...
				<span onclick="closeModal()"
					style="cursor: pointer; font-size: 20px; color: #999;">&times;</span>
			</div>
			<div class="modal-body">
				<input type="hidden" id="origin_code">
				<div class="form-group">
					<label>검사번호</label> <input type="text" id="modal_code"
						name="quality_code" class="input-field">
				</div>
				<div class="form-group">
					<label>검사수량</label> <input type="number" id="modal_qty"
						name="inspect_qty" class="input-field">
				</div>
				<div class="form-group">
					<label>상태</label> <select id="modal_status" name="qc_status"
						class="input-field">
				...
				<div class="form-group">
					<label>검사일자</label> <input type="date" id="modal_date"
						name="inspect_date" class="input-field">
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn-white" style="width: 80px;"
					onclick="closeModal()">취소</button>
				<button type="button" class="btn-blue" style="width: 120px;"
					id="modalSubmitBtn">수정하기</button>
			</div>
		</div>
	</div>
	</main>
