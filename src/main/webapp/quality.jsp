    ...
    <script>
        ...
        function sendData(mode) {
            ...
            const params = {
                ...
                quality_code: code,
                item_code: document.getElementById("modal_item_code").value.trim(),
                item_name: document.getElementById("modal_item_name").value.trim(),
                ...
                <div class="card">
                    ...
                    <div class="table-wrap">
                        <table>
                            <thead>
                                <tr>
                                    <th onclick="toggleAllByText()" style="cursor:pointer;">선택</th>
                                    <th>검사번호</th>
                                    <th>품목코드</th>
                                    <th>품목명</th>
                                    <th>유형</th>
                            ...
                            <tbody>
                                <c:forEach var="m" items="${list}">
                                    ...
                                    <tr onclick="openEditModal('${m.quality_code}', '${m.item_code}', '${m.item_name}', '${m.inspect_type}', '${m.inspect_qty}', '${m.qc_status}', '${m.inspector}', '${fmtDate}', '${m.remarks}')">
                                        <td onclick="stopProp(event)"><input type="checkbox" name="chk_quality" value="${m.quality_code}"></td>
                                ...
                                <c:if test="${empty list}">
                                    <tr><td colspan="9" style="text-align:center; padding:30px;">데이터가 없습니다.</td></tr>
                                </c:if>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="summary-content">
                        <div style="display: flex; justify-content: space-between; padding: 15px 0; border-bottom: 1px solid #f1f5f9;">
                            <span>재검 건수</span><span style="color: #b7791f; font-weight: 700;">${recheckCount != null ? recheckCount : 0}건</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; padding: 15px 0;">
                            <span>품질 상태</span><span style="color: #38a169; font-weight: 700;">양호</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    <label>검사번호</label> <input type="text" id="modal_code" class="input-field">
                                </div>
                                <div class="form-group">
                                    <label>품목코드</label> <input type="text" id="modal_item_code" class="input-field">
                                </div>
                                <div class="form-group">
                                    <label>품목명</label> <input type="text" id="modal_item_name" class="input-field">
                                </div>
                                <div class="form-group">
                                    <label>검사유형</label> <input type="text" id="modal_type" class="input-field">
                                </div>
                                <div class="form-group">
                                    <label>검사수량</label> <input type="number" id="modal_qty" class="input-field">
                                </div>
                                <div class="form-group">
                                    <label>검사자</label> <input type="text" id="modal_inspector" class="input-field">
                                </div>
                                <div class="form-group">
                                    <label>상태</label> 
                                ...
                                <div class="form-group">
                                    <label>검사일자</label> <input type="date" id="modal_date" class="input-field">
                                </div>
                            </div>
