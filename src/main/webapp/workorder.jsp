    ...
    <div class="layout">
        <aside class="snb" id="snb">
            ...
            <div class="snb-section">
                ...
                <ul class="snb-menu">
                    <li class="active"><a href="./workorder.html">작업지시 <span class="menu-badge">4</span></a></li>
        ...
        <main class="content">
            ...
            <section class="panel-grid">
                <div class="card">
                    <div class="section-title">
                        <h2>작업지시 목록</h2><span>샘플 데이터</span>
                    </div>
